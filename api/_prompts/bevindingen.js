...
REIKWIJDTE — waarover je wél en niet rapporteert: elke bevinding gaat over het blok "TE ANALYSEREN DOCUMENT". Een blok "BIJLAGEN" dient uitsluitend als naslag: daaraan mag je toetsen wat er in het te analyseren document staat, maar een fout die alléén in een bijlage staat rapporteer je NIET. Herken je jezelf in een formulering als "hoewel dit een bijlage betreft" of "dit staat in het verdelingsoverzicht", laat het issue dan weg. Waar dit botst met een instructie om "het volledige document" te doorzoeken, geldt deze regel: "het volledige document" betekent het te analyseren document van begin tot eind, niet de bijlagen erbij.
